...
//
// This is a modified version of the btcsuite::wire::Peer
// implementation that's stripped down to run leaner
package lib
...
type MessageListeners struct {
	...
	OnGetAddr func(p *Witness, msg *wire.MsgGetAddr)

	// OnAddr is invoked when a peer receives an addr bitcoin message.
	OnAddr func(p *Witness, msg *wire.MsgAddr)

	// OnPing is invoked when a peer receives a ping bitcoin message.
	OnPing func(p *Witness, msg *wire.MsgPing)

	// OnPong is invoked when a peer receives a pong bitcoin message.
	OnPong func(p *Witness, msg *wire.MsgPong)

	// OnAlert is invoked when a peer receives an alert bitcoin message.
	OnAlert func(p *Witness, msg *wire.MsgAlert)

	// OnMemPool is invoked when a peer receives a mempool bitcoin message.
	OnMemPool func(p *Witness, msg *wire.MsgMemPool)

	// OnTx is invoked when a peer receives a tx bitcoin message.
	OnTx func(p *Witness, msg *wire.MsgTx)

	// OnBlock is invoked when a peer receives a block bitcoin message.
	OnBlock func(p *Witness, msg *wire.MsgBlock, buf []byte)

	// OnCFilter is invoked when a peer receives a cfilter bitcoin message.
	OnCFilter func(p *Witness, msg *wire.MsgCFilter)

	// OnCFHeaders is invoked when a peer receives a cfheaders bitcoin
	// message.
	OnCFHeaders func(p *Witness, msg *wire.MsgCFHeaders)

	// OnCFCheckpt is invoked when a peer receives a cfcheckpt bitcoin
	// message.
	OnCFCheckpt func(p *Witness, msg *wire.MsgCFCheckpt)

	// OnInv is invoked when a peer receives an inv bitcoin message.
	OnInv func(p *Witness, msg *wire.MsgInv)

	// OnHeaders is invoked when a peer receives a headers bitcoin message.
	OnHeaders func(p *Witness, msg *wire.MsgHeaders)

	// OnNotFound is invoked when a peer receives a notfound bitcoin
	// message.
	OnNotFound func(p *Witness, msg *wire.MsgNotFound)

	// OnGetData is invoked when a peer receives a getdata bitcoin message.
	OnGetData func(p *Witness, msg *wire.MsgGetData)

	// OnGetBlocks is invoked when a peer receives a getblocks bitcoin
	// message.
	OnGetBlocks func(p *Witness, msg *wire.MsgGetBlocks)

	// OnGetHeaders is invoked when a peer receives a getheaders bitcoin
	// message.
	OnGetHeaders func(p *Witness, msg *wire.MsgGetHeaders)

	// OnGetCFilters is invoked when a peer receives a getcfilters bitcoin
	// message.
	OnGetCFilters func(p *Witness, msg *wire.MsgGetCFilters)

	// OnGetCFHeaders is invoked when a peer receives a getcfheaders
	// bitcoin message.
	OnGetCFHeaders func(p *Witness, msg *wire.MsgGetCFHeaders)

	// OnGetCFCheckpt is invoked when a peer receives a getcfcheckpt
	// bitcoin message.
	OnGetCFCheckpt func(p *Witness, msg *wire.MsgGetCFCheckpt)

	// OnFeeFilter is invoked when a peer receives a feefilter bitcoin message.
	OnFeeFilter func(p *Witness, msg *wire.MsgFeeFilter)

	// OnFilterAdd is invoked when a peer receives a filteradd bitcoin message.
	OnFilterAdd func(p *Witness, msg *wire.MsgFilterAdd)

	// OnFilterClear is invoked when a peer receives a filterclear bitcoin
	// message.
	OnFilterClear func(p *Witness, msg *wire.MsgFilterClear)

	// OnFilterLoad is invoked when a peer receives a filterload bitcoin
	// message.
	OnFilterLoad func(p *Witness, msg *wire.MsgFilterLoad)

	// OnMerkleBlock  is invoked when a peer receives a merkleblock bitcoin
	// message.
	OnMerkleBlock func(p *Witness, msg *wire.MsgMerkleBlock)
	...
	OnRead func(p *Witness, bytesRead int, msg wire.Message, err error)
	...
	OnWrite func(p *Witness, bytesWritten int, msg wire.Message, err error)
}

// WitnessConfig is the struct to hold configuration options useful to Witness.
...
// Witness provides a basic concurrent safe bitcoin peer for handling bitcoin
...
func (p *Witness) String() string {
	return fmt.Sprintf("%s (inbound: %t)", p.addr, p.inbound)
}

// UpdateLastBlockHeight updates the last known block for the peer.
//
// This function is safe for concurrent access.
func (p *Witness) UpdateLastBlockHeight(newHeight int32) {
	p.statsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *Witness) UpdateLastAnnouncedBlock(blkHash *chainhash.Hash) {
...
//
// This function is safe for concurrent access.
func (p *Witness) AddKnownInventory(invVect *wire.InvVect) {
...
//
// This function is safe for concurrent access.
func (p *Witness) StatsSnapshot() *StatsSnap {
	p.statsMtx.RLock()
...
//
// This function is safe for concurrent access.
func (p *Witness) NA() *wire.NetAddress {
	p.flagsMtx.Lock()
	na := p.na
	p.flagsMtx.Unlock()
...
//
// This function is safe for concurrent access.
func (p *Witness) Services() wire.ServiceFlag {
	p.flagsMtx.Lock()
	services := p.services
	p.flagsMtx.Unlock()
...
//
// This function is safe for concurrent access.
func (p *Witness) UserAgent() string {
	p.flagsMtx.Lock()
	userAgent := p.userAgent
	p.flagsMtx.Unlock()
...
//
// This function is safe for concurrent access.
func (p *Witness) LastAnnouncedBlock() *chainhash.Hash {
	p.statsMtx.RLock()
...
//
// This function is safe for concurrent access.
func (p *Witness) LastPingNonce() uint64 {
	p.statsMtx.RLock()
	lastPingNonce := p.lastPingNonce
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *Witness) LastPingTime() time.Time {
	p.statsMtx.RLock()
	lastPingTime := p.lastPingTime
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *Witness) LastPingMicros() int64 {
	p.statsMtx.RLock()
	lastPingMicros := p.lastPingMicros
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *Witness) VersionKnown() bool {
	p.flagsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *Witness) VerAckReceived() bool {
	p.flagsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *Witness) ProtocolVersion() uint32 {
	p.flagsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *Witness) LastBlock() int32 {
	p.statsMtx.RLock()
	lastBlock := p.lastBlock
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *Witness) LastSend() time.Time {
...
//
// This function is safe for concurrent access.
func (p *Witness) LastRecv() time.Time {
...
func (p *Witness) LocalAddr() net.Addr {
...
//
// This function is safe for concurrent access.
func (p *Witness) BytesSent() uint64 {
...
//
// This function is safe for concurrent access.
func (p *Witness) BytesReceived() uint64 {
...
//
// This function is safe for concurrent access.
func (p *Witness) TimeConnected() time.Time {
	p.statsMtx.RLock()
...
//
// This function is safe for concurrent access.
func (p *Witness) TimeOffset() int64 {
	p.statsMtx.RLock()
	timeOffset := p.timeOffset
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *Witness) StartingHeight() int32 {
	p.statsMtx.RLock()
	startingHeight := p.startingHeight
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *Witness) WantsHeaders() bool {
	p.flagsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *Witness) IsWitnessEnabled() bool {
	p.flagsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *Witness) PushAddrMsg(addresses []*wire.NetAddress) ([]*wire.NetAddress, error) {
...
//
// This function is safe for concurrent access.
func (p *Witness) PushGetBlocksMsg(locator blockchain.BlockLocator, stopHash *chainhash.Hash) error {
...
//
// This function is safe for concurrent access.
func (p *Witness) PushGetHeadersMsg(locator blockchain.BlockLocator, stopHash *chainhash.Hash) error {
	// Extract the begin hash from the block locator, if one was specified,
...
//
// This function is safe for concurrent access.
func (p *Witness) PushRejectMsg(command string, code wire.RejectCode, reason string, hash *chainhash.Hash, wait bool) {
...
func (p *Witness) handlePingMsg(msg *wire.MsgPing) {
...
func (p *Witness) handlePongMsg(msg *wire.MsgPong) {
...
func (p *Witness) readMessage(encoding wire.MessageEncoding) (wire.Message, []byte, error) {
...
func (p *Witness) writeMessage(msg wire.Message, enc wire.MessageEncoding) error {
...
func (p *Witness) isAllowedReadError(err error) bool {
...
func (p *Witness) shouldHandleReadError(err error) bool {
...
func (p *Witness) maybeAddDeadline(pendingResponses map[string]time.Time, msgCmd string) {
...
// should be logged.
func (p *Witness) shouldLogWriteError(err error) bool {
...
//
// This function is safe for concurrent access.
func (p *Witness) QueueMessage(msg wire.Message, doneChan chan<- struct{}) {
...
//
// This function is safe for concurrent access.
func (p *Witness) QueueMessageWithEncoding(msg wire.Message, doneChan chan<- struct{},
	encoding wire.MessageEncoding) {
...
//
// This function is safe for concurrent access.
func (p *Witness) QueueInventory(invVect *wire.InvVect) {
...
func (p *Witness) readRemoteVersionMsg() error {
...
// remote peer.
func (p *Witness) localVersionMsg() (*wire.MsgVersion, error) {
	var blockNum int32
...
func (p *Witness) writeLocalVersionMsg() error {
...
// it returns an error.
func (p *Witness) negotiateInboundProtocol() error {
...
// it returns an error.
func (p *Witness) negotiateOutboundProtocol() error {
...
func (p *Witness) AssociateConnection(conn net.Conn) {
	// Already connected?
...
// Disconnect.
func (p *Witness) WaitForDisconnect() {
	<-p.quit
}
...
func newPeerBase(origCfg *WitnessConfig, inbound bool) *Witness {
...
func NewInboundPeer(cfg *WitnessConfig) *Witness {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound bitcoin peer.
func NewOutboundPeer(cfg *WitnessConfig, addr string) (*Witness, error) {
